 ...
 * currently 20 games × 10 XP = 200 XP. Rescale when the game count changes.
 */
export const ranks: Rank[] = [
  ...
  { xp: 160, emoji: "👾", title: { en: "Sorting Star", id: "Bintang Pemilah" } },
  { xp: 200, emoji: "👑", title: { en: "True Programmer", id: "Programmer Sejati" } },
];
